...
export const easytCopy = {
  en: {
    nav: { back: "Back", home: "Home", prototype: "Prototype", trips: "My trips", newTrip: "New trip", stamped: "Stamps", account: "Account", profile: "Profile", language: "Language", tour: "How EasyT works", signOut: "Sign out" },
  ...
  es: {
    nav: { back: "Atrás", home: "Inicio", prototype: "Prototipo", trips: "Mis viajes", newTrip: "Nuevo viaje", stamped: "Sellos", account: "Cuenta", profile: "Perfil", language: "Idioma", tour: "Cómo funciona EasyT", signOut: "Cerrar sesión" },
