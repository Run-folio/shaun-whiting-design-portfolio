...
export const easytCopy = {
  en: {
    nav: { back: "Back", home: "Home", prototype: "Prototype", trips: "Trips", newTrip: "New trip", stamped: "Stamps", account: "Account", profile: "Profile", language: "Language", tour: "Guide", signOut: "Sign out" },
  ...
  es: {
    nav: { back: "Atrás", home: "Inicio", prototype: "Prototipo", trips: "Viajes", newTrip: "Nuevo viaje", stamped: "Sellos", account: "Cuenta", profile: "Perfil", language: "Idioma", tour: "Guía", signOut: "Cerrar sesión" },
